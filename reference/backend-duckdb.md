...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmpShkFGm/file4ae64565a62c.csv') q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpShkFGm/file4ae64565a62c.csv"
...
#>   read_csv_auto('/tmp/RtmpShkFGm/file4ae64565a62c.csv')) q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpShkFGm/file4ae64565a62c.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmpShkFGm/file4ae64565a62c.csv')) q02
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
