...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmplcbbAY/file5f3325922aca.csv') q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmplcbbAY/file5f3325922aca.csv"
...
#>   read_csv_auto('/tmp/RtmplcbbAY/file5f3325922aca.csv')) q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmplcbbAY/file5f3325922aca.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmplcbbAY/file5f3325922aca.csv')) q02
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
