...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmpzefKy2/file6c4d19d9653c.csv') q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpzefKy2/file6c4d19d9653c.csv"
...
#>   read_csv_auto('/tmp/RtmpzefKy2/file6c4d19d9653c.csv')) q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpzefKy2/file6c4d19d9653c.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmpzefKy2/file6c4d19d9653c.csv')) q02
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
