...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmpV7H5h1/file4dd73556edf.csv') q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpV7H5h1/file4dd73556edf.csv"
...
#>   read_csv_auto('/tmp/RtmpV7H5h1/file4dd73556edf.csv')) q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpV7H5h1/file4dd73556edf.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmpV7H5h1/file4dd73556edf.csv')) q02
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
