...
db %>%
  ...
  select(b)
#> # A query:  ?? x 1
#> # Database: DuckDB 1.5.5 [unknown@Linux 7.0.0-1011-azure:R 4.6.1/:memory:]
#>   b    
#>   <chr>
#> 1 c    
#> 2 d    
...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmpfzS1nK/file421f76837b28.csv') AS q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpfzS1nK/file421f76837b28.csv"
...
#>   read_csv_auto('/tmp/RtmpfzS1nK/file421f76837b28.csv')) AS q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpfzS1nK/file421f76837b28.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmpfzS1nK/file421f76837b28.csv')) AS...
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
