...
#> ℹ Using SQL: SELECT * FROM (FROM '/tmp/RtmpYwzuoW/file43044e8544df.csv') AS q01
#>   WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpYwzuoW/file43044e8544df.csv"
...
#>   read_csv_auto('/tmp/RtmpYwzuoW/file43044e8544df.csv')) AS q02 WHERE (0 = 1)
#> Caused by error in `dbSendQuery()`:
#> ! IO Error: No files found that match the pattern "/tmp/RtmpYwzuoW/file43044e8544df.csv"
#> 
#> LINE 2: FROM (FROM read_csv_auto('/tmp/RtmpYwzuoW/file43044e8544df.csv')) AS...
#>                    ^
#> ℹ Context: rapi_prepare
#> ℹ Error type: IO
db_csv %>%
