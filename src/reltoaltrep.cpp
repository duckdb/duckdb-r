...
void RelToAltrep::Initialize(DllInfo *dll) {
	...
	rownames_class = R_make_altinteger_class("reltoaltrep_rownames_class", "duckdb.1.4", dll);
	logical_class = R_make_altlogical_class("reltoaltrep_logical_class", "duckdb.1.4", dll);
	int_class = R_make_altinteger_class("reltoaltrep_int_class", "duckdb.1.4", dll);
	real_class = R_make_altreal_class("reltoaltrep_real_class", "duckdb.1.4", dll);
	string_class = R_make_altstring_class("reltoaltrep_string_class", "duckdb.1.4", dll);
...
#if defined(R_HAS_ALTLIST)
	list_class = R_make_altlist_class("reltoaltrep_list_class", "duckdb.1.4", dll);
	...
	struct_class = R_make_altlist_class("reltoaltrep_struct_class", "duckdb.1.4", dll);
