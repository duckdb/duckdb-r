...
- Silence storage message for GeoTox’s transitive use (temporary)
...
- Stop announcing storage location after an explicit choice
...
- Branching strategy: release-process state machine + series invariants
  ([\#2367](https://github.com/duckdb/duckdb-r/issues/2367)).
