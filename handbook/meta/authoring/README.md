...
How to write the prose of a handbook page —
the checklist an author runs through while writing a leaf.
The tree's structure, growth, and enforcement are
[`meta/handbook/`](/handbook/meta/handbook/README.md)'s;
where a rule has its full form there, the line here links it.
...
* **State durable facts only:**
  name the mechanism, not the tally;
  a measurement carries its provenance
  ([the forms](/handbook/meta/handbook/README.md#the-forms)).
* **Treat a default as a fact:** give the value and where it is set
  ([the forms](/handbook/meta/handbook/README.md#the-forms)).
