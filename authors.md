...
Source:
[`DESCRIPTION`](https://github.com/duckdb/duckdb-r/blob/cran-1.5.2.9900/DESCRIPTION)

Mühleisen H, Raasveldt M (2026). *duckdb: DBI Package for the DuckDB
Database Management System*. R package version 1.5.2.9900,
<https://r.duckdb.org/>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 1.5.2.9900},
