...
This package is the `duckdb.2.0.dev` flavor of those bindings,
...
``` r
install.packages("duckdb.2.0.dev", repos = c("https://duckdb.r-universe.dev", "https://cloud.r-project.org"))
```
