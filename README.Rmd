...
# The table and the note below it are written from scripts/series.yaml; edit the
# declaration, not this file. scripts/series-table.R is the generator, and the
# handbook's copy of the same table is spliced by running it.
