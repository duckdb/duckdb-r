...
|---|---|---|---|
| `duckdb` | [`v1.5-variegata`](https://github.com/duckdb/duckdb/tree/v1.5-variegata) | CRAN | [![CRAN](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fpackagemanager.posit.co%2F__api__%2Frepos%2Fcran%2Fpackages%2Fduckdb&query=%24.version&label=CRAN&color=green)](https://cran.r-project.org/package=duckdb) |
...
The first badge on every row is the published version — from CRAN where the
flavor ships there, from r-universe otherwise, and the flavor's name is a link
on it rather than on the name itself.
