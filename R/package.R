...
# `system_file_path()` (called with no `...`) is the mockable seam for the package's installed library directory;
# tests stub it instead of resolving the real install path.
