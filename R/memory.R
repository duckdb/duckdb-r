# Documentation for memory-efficient reading and writing: the limit, the
# streaming read, and the routes that let the engine scan a data frame or a
# file in place. A concept page with no function behind it, like `?duckdb_storage`.
# Handbook: handbook/usage/memory/README.md owns the facts; this page shows one way.
...
#' This page shows memory-efficient ways for reading and writing:
#'
#' - Memory limits
#' - Streamed reading via Arrow
#' - Registering a data frame for writing
#'
#' The routes below keep R's share to one batch, or one data frame, at a time.
#' Follow these recipes to process datasets larger than memory.
#'
...
#'
#' @seealso [duckdb_result_arrow] for the Arrow result and what releases a batch,
