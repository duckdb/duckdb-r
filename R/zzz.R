.onLoad <- function(...) {
  # Populated by R/cxx_runtime.R, generated by ./configure. Falls back to ""
  # when the package is loaded without going through configure (e.g.
  # devtools::load_all() on a clean checkout). See default_extension_directory().
  the$cxx_runtime <- tryCatch(.duckdb_cxx_runtime, error = function(e) "")
