...
*Handbook: [`build/source-build/`](/handbook/build/source-build/README.md).*
...
Bootstrap, the source build, and the `UserNM` caveat: [`handbook/build/source-build/`](/handbook/build/source-build/README.md).
...
The source build command, and why `UserNM` must not reach `R CMD check`: [`handbook/build/source-build/`](/handbook/build/source-build/README.md).
...
The `.dd` dependency files in `src/`, and when a change to them is spurious: [`handbook/build/source-build/`](/handbook/build/source-build/README.md).
