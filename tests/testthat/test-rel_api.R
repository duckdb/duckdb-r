...
test_that("relational mutate(c = 10, d = log(c)) order-preserving", {
  ...
  rel2 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- if ("experimental" %in% names(formals(expr_constant))) {
          expr_constant(10, experimental = experimental)
        } else {
          expr_constant(10)
        }
        expr_set_alias(tmp_expr, "c")
...
test_that("relational mutate(c = NA_character_, d = grepl('.', c)) order-preserving", {
  ...
  rel2 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- if ("experimental" %in% names(formals(expr_constant))) {
          expr_constant(NA_character_, experimental = experimental)
        } else {
          expr_constant(NA_character_)
        }
        expr_set_alias(tmp_expr, "c")
        tmp_expr
      }
    ...
    list(
      ...
      },
      {
        tmp_expr <- expr_function(
          ...
          list(
            if ("experimental" %in% names(formals(expr_constant))) {
              expr_constant(".", experimental = experimental)
            } else {
              expr_constant(".")
            },
            expr_reference("c")
...
test_that("relational mutate(d = a %in% NA_real_) order-preserving", {
  ...
  con <- dbConnect(drv)
  experimental <- FALSE
  invisible(dbExecute(con, 'CREATE MACRO "is.na"(x) AS (x IS NULL OR isnan(x))'))
  df1 <- data.frame(a = seq(1, 6, by = 1), b = rep(2, 6L), g = c(1L, 2L, 2L, 3L, 3L, 3L))
...
test_that("relational mutate(d = NA_real_, e = is.na(d)) order-preserving", {
  ...
  rel2 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- if ("experimental" %in% names(formals(expr_constant))) {
          expr_constant(NA_real_, experimental = experimental)
        } else {
          expr_constant(NA_real_)
        }
        expr_set_alias(tmp_expr, "d")
        tmp_expr
      }
...
test_that("relational mutate(d = NaN, e = is.na(d)) order-preserving", {
  ...
  rel2 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- if ("experimental" %in% names(formals(expr_constant))) {
          expr_constant(NaN, experimental = experimental)
        } else {
          expr_constant(NaN)
        }
        expr_set_alias(tmp_expr, "d")
      ...
      },
      {
        tmp_expr <- expr_function(
          ...
          list(
            ...
            if ("experimental" %in% names(formals(expr_constant))) {
              expr_constant("ok", experimental = experimental)
            } else {
              expr_constant("ok")
            },
            if ("experimental" %in% names(formals(expr_constant))) {
              expr_constant(NA, experimental = experimental)
            } else {
              expr_constant(NA)
            }
          )
...
test_that("relational symdiff() order-preserving", {
  ...
  "union_all"
  rel9 <- rel_from_df(con, df3, experimental = experimental)
  df4 <- data.frame(a = 5L, b = 2)

  "union_all"
  rel10 <- rel_from_df(con, df4, experimental = experimental)
  "union_all"
  rel11 <- rel_project(
    rel9,
    list(
  ...
  "union_all"
  rel13 <- rel_union_all(rel11, rel12)
  "union_all"
  rel14 <- rel_order(
    rel13,
    list(expr_reference("___row_number_x"), expr_reference("___row_number_y"))
  ...
  "distinct"
  rel19 <- rel_order(rel18, list(expr_reference("___row_number")))
  "distinct"
  rel20 <- rel_project(
    rel19,
    list(
