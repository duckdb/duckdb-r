...
test_that("relational mutate(c = 0, d = -1, e = log(c), f = log(d)) order-preserving", {
  ...
  rel5 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- expr_function("___log", list(expr_reference("d")))
        expr_set_alias(tmp_expr, "f")
        tmp_expr
      }
    )
...
test_that("relational mutate(c = 0, d = -1, e = log10(c), f = log10(d)) order-preserving", {
  # Autogenerated
  con <- dbConnect(duckdb())
  experimental <- FALSE
  invisible(
  ...
  rel5 <- rel_project(
    ...
    list(
      ...
      {
        tmp_expr <- expr_function("___log10", list(expr_reference("d")))
        expr_set_alias(tmp_expr, "f")
        tmp_expr
      }
    )
...
test_that("relational mutate(c = 0, d = -1, e = log10(c), f = log10(d)) order-enforcing", {
  # Autogenerated
  con <- dbConnect(duckdb())
  experimental <- FALSE
  invisible(
