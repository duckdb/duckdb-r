...
| A private context behind a streaming result, so a stream survives the next statement on its connection, and why not one behind every result | [`PLAN-result-contexts.md`](PLAN-result-contexts.md) |
